  ...
  group('Interface', () {
    ...
    group('#trace', () {
      ...
      test('correctly emits logs', () async {
        ...
        final timer = logger.time('start trace');
      ...
      test('accepts custom severity level', () async {
        ...
        logger.time('start', level: Level.fatal).stop('stop');
      ...
      test('ignores further timer stop calls after the first one', () {
        ...
        final t = logger.time('start')..stop('stop');
    ...
    test('accepts additional fields on stop', () async {
      ...
      logger.time('start').stop('stop', fields: fields);
    ...
    test('accepts custom level on stop', () async {
      ...
      logger.time('start').stop('stop', level: Level.fatal);
